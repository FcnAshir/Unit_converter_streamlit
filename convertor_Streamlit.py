...
def weight_convertor(value, from_unit, to_unit):
    weight_units = {
        'Kilogram': 1, 'Grams': 1000, 'Miligram': 1000000, 'Pounds': 2.2046, 'Ounces': 35.27
    }
    
    return value * (weight_units[to_unit] / weight_units[from_unit])

#Tempreture converter function
...
st.markdown("<div class='footer'>Created  by Syed NoorAlam </div>", unsafe_allow_html=True)
